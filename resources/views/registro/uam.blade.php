...
<div class="registro">
    <h2>Registro Estudiantes UAM</h2>
    ...
    <form action="{{ route('registro.uam.store') }}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col"><input type="text" name="apellidos" class="form-control" placeholder="Apellidos" required></div>
        </div>
        <input type="email" name="correo" class="form-control mb-3" placeholder="Correo institucional" required>
        <input type="text" name="identificador" class="form-control mb-3" placeholder="CIF" required>
